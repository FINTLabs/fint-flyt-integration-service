...
class ReferencedConfigurationIsForIntegrationValidator :
    HibernateConstraintValidator<ReferencedConfigurationIsForIntegration, Long> {
    override fun isValid(
        ...
        return value == null ||
            integrationValidationContext?.configuration?.integrationId == integrationValidationContext?.integrationId
    }
}

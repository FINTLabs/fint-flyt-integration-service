package no.novari.integration.kafka;

import no.novari.integration.IntegrationService;
import no.novari.integration.model.dtos.IntegrationDto;
import no.novari.integration.model.dtos.SourceApplicationIdAndSourceApplicationIntegrationIdDto;
